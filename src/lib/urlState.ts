...
): Partial<{ videoId: string; seekTime: number; speed: number; slowMoSpeed: number; holdTickRateMs: number }> {
  const out: Partial<{ videoId: string; seekTime: number; speed: number; slowMoSpeed: number; holdTickRateMs: number }> = {};
