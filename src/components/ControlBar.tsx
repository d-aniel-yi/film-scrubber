          ...
          {canControl && scrubber && onStepPresetChange && (
            <>
              ...
              <button
                ...
                className="touch-none rounded border border-zinc-300 bg-white px-2 py-1.5 text-sm hover:bg-zinc-100 dark:border-zinc-600 dark:bg-zinc-800 dark:hover:bg-zinc-700"
